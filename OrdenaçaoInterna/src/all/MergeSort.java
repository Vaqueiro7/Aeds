...
public class MergeSort {
	...
	public MergeSort(int[] vetor, int n) {
		...
		// Método que irá ordenar os vetor com o algoritmo Merge Sort e calculará o
	...
	// função que realiza as ordenações de forma recursiva e calcula o número de
	// comparações e acessos
