...
public class Main {
    public static void main(String[] args) {
		...
		//cabeçalho com os dados dos alunos
                ...
                // Ordenação dos vetores de 5000, 10000 e 30000 posições com o uso do Insertion Sort, respectivamente
		...
		ordenaVetorInsertionSort i30k = new ordenaVetorInsertionSort(auxiliar.Vetor30, 30000);                
                ...
                // Ordenação dos vetores de 5000, 10000 e 30000 posições com o uso do Merge Sort, respectivamente
		...
		// Ordenação dos vetores de 5000, 10000 e 30000 posições com o uso do Quick Sort, respectivamente
		...
		QuickSort Q30k = new QuickSort(auxiliar.Vetor30, 30000);
                ...
                System.out.println("\n           ORDENAÇÃO                                                               VETOR                                             ");
                System.out.println("--------------------------------    -------------------------------------------------------------------------------------------------  ");
                System.out.println("MÉTODO         TEMPO TOTAL (ms)         ACESSOS            COMPARAÇÕES            TROCAS             INSERÇÕES             PIVÔS       ");
                System.out.println("            5000   10000   30000    5000 10000 30000    5000 10000 30000     5000 10000 30000    5000 10000 30000    5000 10000 30000"  );
                System.out.println("---------   ----   -----   -----    ---- ----- -----    ---- ----- -----     ---- ----- -----    ---- ----- -----    ---- ----- ----- ");
                
                System.out.println("Insertion   " + i5k.gettempo() + " " +i10k.gettempo() + " "+ i30k.gettempo()+ "  "
                        + i5k.getcontadorAI()+ " " + i10k.getcontadorAI()+ " " + i30k.getcontadorAI()+ "  "
                        + i5k.getcompI() + " " + i10k.getcompI()+ " " + i30k.getcompI() + "                                         "
                ...
                System.out.println("Merge       " + m5k.gettempo() + " " + m10k.gettempo() + " "+ m30k.gettempo()+ "  "
                        + m5k.getcontadorA()+ " " + m10k.getcontadorA()+ " " + m30k.getcontadorA()+ "  "
                        + m5k.getcompM()+ " " + m10k.getcompM()+ " " + m30k.getcompM());
                
                
                System.out.println("Quick       " + Q5k.gettempo() + " " + Q10k.gettempo() + " " + Q30k.gettempo()  
                        + "  " + Q5k.getcontadorAQ() + " " + Q10k.getcontadorAQ() + " " + Q30k.getcontadorAQ() 
                        + "  " + Q5k.getcompQ() + " " + Q10k.getcompQ() + " " + Q30k.getcompQ() + "  " 
                        + Q5k.gettrocas() + " " + Q10k.gettrocas() + " " + Q30k.gettrocas() + "                       " 
                        + Q5k.getpivoQ()+ " "+ Q10k.getpivoQ()+ " "+ Q30k.getpivoQ());
